...
recipes = pd.read_csv('train_lexical_feature.csv')
#recipes
...
X = recipes[['Article_len','Avg_Word_Len','CountofExclamation','adjectives','WordCount','sent_neg','sent_neu','sent_pos']].as_matrix()
...
# Read in muffin and cupcake ingredient data# Read i
#recipes = pd.read_csv('test_liar_feature.csv')
recipes = pd.read_csv('test_lexical_feature.csv')
#recipes
