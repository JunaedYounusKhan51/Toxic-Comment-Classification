...
pickle_train=open('Pickles/pickle_toxic_clean_balanced_train_Xy.pickle','rb')
...
with open('Pickles/pickle_toxic_embedding_balanced_train_100dim.pickle','wb') as f:
...
dataset=pd.read_csv('balanced_train_binary_data.csv')
y_train=dataset.iloc[:,2:3].values

print(len(X_train),len(y_train))

with open('Pickles/pickle_toxic_embedding_balanced_train_binary_100dim.pickle','wb') as f:
    pickle.dump((X_train,y_train,embedding_matrix),f)
...
pickle_test=open('Pickles/pickle_toxic_clean_balanced_test_Xy.pickle','rb')
...
with open('Pickles/pickle_toxic_embedding_balanced_test.pickle','wb') as f_test:
    pickle.dump((X_test,y_test),f_test)

###########################  Balanced ####################

dataset=pd.read_csv('balanced_test_binary_data.csv')
y_test=dataset.iloc[:,2:3].values
with open('Pickles/pickle_toxic_embedding_balanced_test_binary.pickle','wb') as f:
