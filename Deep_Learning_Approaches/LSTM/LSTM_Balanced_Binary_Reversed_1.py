...
model_name = 'Models/LSTM/Model_LSTM_balanced_Reversed_1_class_2.h5'
cb=callback(model_name=model_name)

model=create_model_LSTM(vocabulary_size,embedding_size,embedding_matrix,num_class=1)
history=model.fit(X_train,y_train,batch_size=512,epochs=10,validation_split=0.2,shuffle=True,callbacks=cb)

print("Saving Model...")
model_name = 'Models/LSTM/Balanced/Model_LSTM_balanced_Reversed_1_class_2_sigmoid_binary_crossentropy.h5'#######################
model.save(model_name)

plot_loss_accu(history,lossLoc='Graph/LSTM/Balanced/Train_Val_Loss_balanced_Reversed_1_class_2_sigmoid_binary_crossentropy',
               accLoc='Graph/LSTM/Balanced/Train_Val_acc_balanced_Reversed_1_class_2_sigmoid_binary_crossentropy')


'''model_1=create_model_LSTM(vocabulary_size,embedding_size,embedding_matrix,num_class=1)
model_1.load_weights(model_name)
model_1.name = 'model_1' '''
model_1=load_model('Models/LSTM/Balanced/Model_LSTM_balanced_Reversed_1_class_2_sigmoid_binary_crossentropy.h5')
...
import pickle
with open('Predictions/LSTM/Balanced/LSTM_balanced_Reversed_1_class_2_sigmoid_binary_crossentropy.pickle','wb') as f:
    pickle.dump((y_test,pred,pred_binary),f)

pickle_load='Predictions/LSTM/Balanced/LSTM_balanced_Reversed_1_class_2_sigmoid_binary_crossentropy.pickle'
