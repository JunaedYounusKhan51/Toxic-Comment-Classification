...
model_name = 'Models/LSTM/Model_LSTM_balanced_1_class_2.h5'
...
print("Saving Model...")
model_name = 'Models/LSTM/Balanced/Model_LSTM_balanced_1_class_2_sigmoid_binary_crossentropy.h5'#######################
model.save(model_name)

plot_loss_accu(history,lossLoc='Graph/LSTM/Balanced/Train_Val_Loss_balanced_1_class_2_sigmoid_binary_crossentropy',
               accLoc='Graph/LSTM/Balanced/Train_Val_acc_balanced_1_class_2_sigmoid_binary_crossentropy')
...
model_1=load_model('Models/LSTM/Balanced/Model_LSTM_balanced_1_class_2_sigmoid_binary_crossentropy.h5')
...
import pickle
with open('Predictions/LSTM/Balanced/LSTM_balanced_1_class_2_sigmoid_binary_crossentropy.pickle','wb') as f:
    pickle.dump((y_test,pred,pred_binary),f)

pickle_load='Predictions/LSTM/Balanced/LSTM_balanced_1_class_2_sigmoid_binary_crossentropy.pickle'
