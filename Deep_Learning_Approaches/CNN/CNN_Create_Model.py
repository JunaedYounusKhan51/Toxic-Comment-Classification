...
############## DENSE Layer ta ar add kori nai ##########################
def create_model_CNN(dimension,vocabulary_size,embedding_size,embedding_matrix,nb_filter,kernel_size,num_class=6):
    model = Sequential()
    model.add(Embedding(vocabulary_size, embedding_size, input_length=dimension,
